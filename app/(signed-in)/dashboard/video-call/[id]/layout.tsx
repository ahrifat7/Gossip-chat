...
function Layout({ children }: { children: React.ReactNode }) {
  ...
  // Use a ref for userId to keep tokenProvider stable
  ...
  useEffect(() => {
    ...
    // Defer setting state to avoid synchronous cascading render warnings
    ...
    const joinCall = async () => {
      try {
        ...
        if (error instanceof Error) {
          ...
          // Check for device permission errors
          if (
            ...
            errorMessage =
              "Camera or microphone access was denied. Please click the lock icon in your browser's address bar to allow permissions, then click Retry.";
          }
